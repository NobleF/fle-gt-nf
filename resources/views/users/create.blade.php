                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <!--<div class="feedback" id="mail_fb">Veuillez saisir un e-mail sans @domain.tld</div>-->
                        </div>
                    </div>
                    <!--Password-->
                    <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <script type="text/javascript">
        /*$(document).ready(function () {
            $('#email').keyup(function () {
                ...
                if (!email.test(VAL)) {
                    document.getElementById('mail_fb').setAttribute("hidden", "true");
                } else {
                    document.getElementById('mail_fb').removeAttribute("hidden");
                }
            });
        });*/
    </script>
